 ...
 */
class Version20180607085458 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE order_offer_buy_item ADD CONSTRAINT FK_F08019E053C674EE FOREIGN KEY (offer_id) REFERENCES order_offer (id) ON DELETE CASCADE');
        $this->addSql('CREATE INDEX IDX_F08019E053C674EE ON order_offer_buy_item (offer_id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE order_offer_buy_item DROP FOREIGN KEY FK_F08019E053C674EE');
