 ...
 */
class Version20170821132306 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user_address CHANGE longitude longitude DOUBLE PRECISION DEFAULT \'0\', CHANGE latitude latitude DOUBLE PRECISION DEFAULT \'0\'');
        $this->addSql('ALTER TABLE `order` CHANGE longitude longitude DOUBLE PRECISION DEFAULT \'0\', CHANGE latitude latitude DOUBLE PRECISION DEFAULT \'0\', CHANGE starting_longitude starting_longitude DOUBLE PRECISION DEFAULT \'0\', CHANGE starting_latitude starting_latitude DOUBLE PRECISION DEFAULT \'0\'');
        $this->addSql('ALTER TABLE user CHANGE longitude longitude DOUBLE PRECISION DEFAULT \'0\', CHANGE latitude latitude DOUBLE PRECISION DEFAULT \'0\'');
    }
